  ...
  useEffect(() => {
    ...
    const mockCourses: Course[] = [
      ...
      },
      {
        ...
        imageUrl:
          "https://phunugioi.com/wp-content/uploads/2022/04/Anh-meme-meo-1.jpg",
        lessonCount: 10,
        totalDuration: "12h",
        enrolledStudents: 85,
      },
      ...
      },
      {
        id: 4,
        title:
          "Khóa học Python cho người mới Khóa học Python cho người mới Khóa học Python cho người mới",
        imageUrl:
          "https://kynguyenlamdep.com/wp-content/uploads/2022/08/meme-meo-loading.jpg",
        lessonCount: 20,
        totalDuration: "25h",
