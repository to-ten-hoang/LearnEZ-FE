...
const testimonials = [
    ...
    {
        name: 'Trần Thị B',
        feedback: 'Khóa học rõ ràng, dễ hiểu, có thống kê quá trình học rất hữu ích!',
        ...
        <div className="Home">
            <div
                ...
                style={{
                    ...
                    marginRight: 24,
                    backgroundImage:
                        "url('https://iigacademy.edu.vn/wp-content/uploads/2021/10/Banner-002-1536x864.jpg')",
            ...
            >
                ...
                >
                    ...
                    <Paragraph style={{ color: 'white', fontSize: 18 }}>
                        Lộ trình học toàn diện – luyện đề – chấm điểm tự động – phân tích điểm
                        mạnh/yếu.
                    </Paragraph>
            ...
            >
                <Row gutter={[32, 32]} align="middle" justify="center">
                    ...
                    {/* ND */}
                    <Col xs={24} md={14}>
                        <Title style={{ fontSize: 30, marginBottom: 30 }} level={3}>
                            Về LearnEZ
                        </Title>
                        <Paragraph style={{ fontSize: 18 }}>
                            Chúng tôi là một nhóm gồm các giảng viên, lập trình viên và chuyên gia
                            giáo dục, luôn nỗ lực tạo ra nền tảng học TOEIC chất lượng cao.
                        </Paragraph>
                        <Paragraph style={{ fontSize: 18, marginBottom: 30 }}>
                            Với đội ngũ nhiều kinh nghiệm và nội dung được cập nhật liên tục, chúng
                            tôi cam kết mang đến cho bạn một trải nghiệm học tập hiệu quả, khoa học
                            và cá nhân hóa.
                        </Paragraph>
            ...
            <div
                className="hot-course"
                style={{ marginBottom: 48, marginLeft: 36, marginRight: 36 }}
            >
                    ...
                    {sampleCourses.map((course) => (
                        <Col key={course.id} xs={24} sm={12} md={8}>
                            ...
                            >
                                ...
                                <p>
                                    <strong>Chuyên mục:</strong> {course.category}
                                </p>
                                <div
                                    style={{
                                        marginTop: 'auto',
                    ...
                    {testimonials.map((item, index) => (
                        <div key={index}>
                            ...
                            >
                                ...
                                <Paragraph style={{ fontSize: 14, color: '#555' }}>
                                    "{item.feedback}"
                                </Paragraph>
                            </Card>
                        </div>
            ...
            >
                <Row gutter={[32, 16]} justify="space-between">
                    <Col xs={24} sm={12} md={10}>
                        ...
                        <Paragraph style={{ color: 'white' }}>
                            Chuyên trang luyện thi TOEIC trực tuyến – cập nhật theo định dạng mới
                            nhất.
                        </Paragraph>
                    </Col>
                    <Col xs={24} sm={12} md={8}>
                        ...
                        <Paragraph style={{ color: 'white' }}>
                            <MailOutlined /> support@toeicweb.vn
                        </Paragraph>
                        <Paragraph style={{ color: 'white' }}>
                    ...
                    <Col xs={24} sm={24} md={6}>
                        ...
                        <Space>
                            ...
                            <Link href="https://youtube.com" target="_blank">
                                <YoutubeFilled style={{ fontSize: 24, color: 'white' }} />
                            </Link>
                        </Space>
                    </Col>
                </Row>
                <div style={{ textAlign: 'center', marginTop: 24 }}>
                    <Text style={{ color: 'white' }}>
                        © {new Date().getFullYear()} TOEIC Learning Platform. Được phát triển bởi
                        Nhóm Phát Triển EdTech.
                    </Text>
                </div>
            </div>
        </div>
